...
def init_state():
    if "inicializado" not in st.session_state:
        ...
        st.session_state.authenticated = True  # Já autenticado aqui
    ...
    with st.form("form_membro", clear_on_submit=True):
        ...
        with c2:
            ...
            if st.form_submit_button("🔎 Buscar CEP"):
                ...
                if dados_cep:
                    st.session_state.endereco, st.session_state.bairro, st.session_state.cidade, st.session_state.uf_end = \
                        dados_cep["endereco"], dados_cep["bairro"], dados_cep["cidade"], dados_cep["uf"]
        ...
        with c3:
            st.selectbox("Grau de Instrução", ["", "Fundamental Incompleto", "Fundamental Completo", "Médio Incompleto", "Médio Completo", "Superior Incompleto", "Superior Completo", "Pós-graduação"], key="grau_ins")
